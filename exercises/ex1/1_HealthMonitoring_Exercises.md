...
Pin a Service to your favorites so that you can see a health summary for this service on your Home. (Directly when launching the application)

## 1.6 Explore What’s New

Figure out the details on what was recently released in the context of the application by using the in-app help 
