...
> Screenshot: Time frame component

- Pick a date that is a few days on the past
> Screenshot: KPI graph

## 1.2 Adjust Resolution
- Open Time Frame 
> Screenshot: Time frame popup
...
- Home
> Screenshot: Health Monitoring - Metrics Overview

- Open Configuration Panel and click on Service “|Service Name|”:
> Screenshot: Configuration

- Configuration for Services
> Screenshot: Configuration for services

- Navigate to Events
> Screenshot: Events tab in configuration dialog

- **Result** 
Alert are active for “High CPU Utilization”, “High Disk Utilization”, and “High Java Memory Utilization”

## 1.5 Add Service to Favorites
- Navigate to the Metric Overview of the Service “|Service Name|”
> Screenshot: Health Monitoring - Metrics Overview

-  Click on “Favorite” Icon
> Screenshot: Health Monitoring - Metrics Overview - favorite icon highlighted

- Navigate to Home and see the results in the favorite section
> Screenshot: Health Monitoring Overview page favorites section

## 1.6 Explore Whats's New
-  Open the In-App Help and Navigate to the What's New area
> Screenshot: What's new button highlighted

- **Result**
> Screenshot: What's new button clicked

## 1.7 In App Help Use Spots
- Open the In-App Help and click on a certain spot (example: Scope Overview)
> Screenshot: In app help active
...
> Screenshot: Cloud logging with time frame selection active

- **Result**
> Screenshot: Cloud logging with applied time frame
