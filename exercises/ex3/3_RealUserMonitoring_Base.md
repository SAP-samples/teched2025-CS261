...
- Click on "KPI Tag"
> Screenshot: Request details RUM

- Navigate to a specific execution
> Screenshot: Execution Details RUM

- Use Zoom
> Screenshot: Execution details with Zoom button focused

- Explore Details
> Screenshot: Execution details popup

- Switch View and expand rows
> Screenshot: Execution table view
